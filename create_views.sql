...
ALTER VIEW geonode.piemonte_aerialway_line OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_aeroway_polygon OWNER TO geonode;
ALTER VIEW geonode.piemonte_aeroway_point OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_amenity_sustenance_point OWNER TO geonode;
ALTER VIEW geonode.piemonte_amenity_education_point OWNER TO geonode;
ALTER VIEW geonode.piemonte_amenity_transportation_point OWNER TO geonode;
ALTER VIEW geonode.piemonte_amenity_financial_point OWNER TO geonode;
ALTER VIEW geonode.piemonte_amenity_healthcare_point OWNER TO geonode;
ALTER VIEW geonode.piemonte_amenity_entertainment_point OWNER TO geonode;
ALTER VIEW geonode.piemonte_amenity_public_service_point OWNER TO geonode;
ALTER VIEW geonode.piemonte_amenity_facilities_point OWNER TO geonode;
ALTER VIEW geonode.piemonte_amenity_waste_management_point OWNER TO geonode;
ALTER VIEW geonode.piemonte_amenity_others_point OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_barrier_line OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_administrative_boundary_polygon OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_park_boundary_polygon OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_building_polygon OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_craft_polygon OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_emergency_point OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_highway_line OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_railway_line OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_railway_point OWNER TO geonode;
#Route
...
ALTER VIEW geonode.piemonte_water_polygon OWNER TO geonode;
...
ALTER VIEW geonode.piemonte_waterway_line OWNER TO geonode;
